...
if ( $_REQUEST['action'] == 'desc' ) {
	...
	while ( count($out['tiles']) < $num ) {
		...
		$instruction = "/usr/bin/python3 StudyApp/get_tile.py -c " . strval($random_number_array[$n]) . " -t geography";
