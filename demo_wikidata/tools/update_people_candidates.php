...
$to_add = array() ;
$sql = "select term_entity_id,term_text from wb_entity_per_page,wb_terms WHERE epp_entity_id=term_entity_id and term_entity_type='item' and term_type IN ('label','alias') and not exists (select * from pagelinks where pl_from=epp_page_id and pl_namespace=120 and pl_title='P31')" ;
if ( $max > 0 ) $sql .= " LIMIT $max" ;
