...
$done = array() ;
$sql = "select distinct epp_entity_id from wb_entity_per_page,pagelinks where epp_entity_type='item' and pl_from=epp_page_id and pl_namespace=120 and pl_title='P373'" ;
